...
Feature: Group Administration
  In order to allow Reef Secretariat to administer membership of contribution groups
    so that they can administer access themselves
    to avoid waiting for the development team
    to reduce the time delay in producing Reef Report Cards
  As a Reef Secretariat member
  I want to be able to assign existing users to contribution groups.

Feature: Administrator Granting
  In order to allow Reef Secretariat to control who is an administrator
    so that they can administer access themselves
    to avoid waiting for the development team
    to reduce the time delay in producing Reef Report Cards
  As a Reef Secretariat member
  I want to be able to assign existing users to the Reef Secretariat.
