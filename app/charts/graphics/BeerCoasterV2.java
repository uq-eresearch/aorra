...
public class BeerCoasterV2 implements Drawable {
  ...
  public static enum Indicator {
    ...
    COVER("Cover", Category.CORAL, -126, -24, Rotation.COUNTER_CLOCKWISE, 228),
    ALGAE("Macroalgae", Category.CORAL, -102, -24, Rotation.COUNTER_CLOCKWISE, 204),
    JUVENILE("Juvenile", Category.CORAL, -78, -24, Rotation.COUNTER_CLOCKWISE, 180),
    SETTLEMENT("Change", Category.CORAL, -54, -24, Rotation.COUNTER_CLOCKWISE, 156),
    COMPOSITION("Composition", Category.CORAL, -30, -24, Rotation.COUNTER_CLOCKWISE, 132),
  ...
  private static final Font INDICATOR_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, 10);
  ...
  public BeerCoasterV2(Map<Condition, Color> colors) {
    this.colors = colors;
  }
