...
public class JackrabbitUserServicePlugin extends UserServicePlugin {

	private final Map<AuthUserIdentity, AuthUser> users = new HashMap<AuthUserIdentity, AuthUser>();

	public JackrabbitUserServicePlugin(Application app) {
		super(app);
	}
	...
	private class ImmutableAuthUserIdentity implements AuthUserIdentity {
		...
		private JackrabbitUserServicePlugin getOuterType() {
			return JackrabbitUserServicePlugin.this;
		}
