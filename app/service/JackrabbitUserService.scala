/**
 * Based on: https://github.com/jaliss/securesocial/blob/master
 *            /samples/scala/demo/app/service/InMemoryUserService.scala
 *
 * No original code is believed to remain except for the API definition.
 */
package service
